...
class Ui_ModifyWindow(object):
    def setupUi(self, ModifyWindow):
        ...
        self.basicTab_browseBtn = QtWidgets.QPushButton(self.groupBox_2)
        self.basicTab_browseBtn.setObjectName("basicTab_browseBtn")
        self.horizontalLayout_6.addWidget(self.basicTab_browseBtn)
        ...
        self.basicTab_copyRecordBtn = QtWidgets.QPushButton(self.groupBox_4)
        self.basicTab_copyRecordBtn.setObjectName("basicTab_copyRecordBtn")
        self.horizontalLayout_7.addWidget(self.basicTab_copyRecordBtn)
        ...
        self.basicTab_modifyFileLineEdit = QtWidgets.QLineEdit(self.groupBox_3)
        self.basicTab_modifyFileLineEdit.setObjectName("basicTab_modifyFileLineEdit")
        self.horizontalLayout_4.addWidget(self.basicTab_modifyFileLineEdit)
        self.basicTab_exportFileBtn = QtWidgets.QPushButton(self.groupBox_3)
        self.basicTab_exportFileBtn.setObjectName("basicTab_exportFileBtn")
        self.horizontalLayout_4.addWidget(self.basicTab_exportFileBtn)
    ...
    def retranslateUi(self, ModifyWindow):
        ...
        self.basicTab_browseBtn.setText(_translate("ModifyWindow", "浏览"))
        self.groupBox_4.setTitle(_translate("ModifyWindow", "修改记录"))
        self.basicTab_copyRecordBtn.setText(_translate("ModifyWindow", "复制记录"))
        ...
        self.groupBox_3.setTitle(_translate("ModifyWindow", "导出-修改后基础变量文件路径"))
        self.basicTab_exportFileBtn.setText(_translate("ModifyWindow", "导出"))
        self.label.setText(_translate("ModifyWindow", "直接覆盖原有基础变量文件"))
