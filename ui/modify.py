...
"border:none;")
        ...
        self.modifyRecordUndoView = QtWidgets.QUndoView(self.groupBox_4)
        self.modifyRecordUndoView.setObjectName("modifyRecordUndoView")
        self.verticalLayout_6.addWidget(self.modifyRecordUndoView)
